...
public class regScreen extends AppCompatActivity implements regScreenView{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter = new regScreenPresenter(this, new regScreenService());
    ...
    public String getPassword() {
        return passwordt.getText().toString().trim();
    }
